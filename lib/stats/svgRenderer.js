...
function fitFontSize(text, { base = 20, min = 13, maxChars = 20 } = {}) {
        const useVerticalMetrics = Boolean(options.vertical) || width < 700;
    const length = String(text || '').length;
    if (length <= maxChars) return base;
        const metricRowGap = Math.round(46 * layoutScale);
        const metricBlockStartY = Math.round(282 * layoutScale);
        const metricBlockEndY = metricBlockStartY + Math.max(0, metrics.length - 1) * metricRowGap;
        const divider2BaseY = Math.round(314 * layoutScale);
        const divider2Y = useVerticalMetrics ? metricBlockEndY + Math.round(26 * layoutScale) : divider2BaseY;
    ...
    return Math.max(min, reduced);
            const gx = useVerticalMetrics ? pad : Math.round(pad + i * metricGap);
            const gy = useVerticalMetrics ? metricBlockStartY + i * metricRowGap : metricsY;
            const iconCenterX = gx + Math.round(10 * layoutScale);
            const iconCenterY = useVerticalMetrics ? gy - Math.round(6 * layoutScale) : metricsY - Math.round(8 * layoutScale);
            const textX = useVerticalMetrics ? gx + Math.round(28 * layoutScale) : gx + Math.round(34 * layoutScale);
function hashString(input) {
    let hash = 0;
    const text = String(input || '');
                iconNode = useVerticalMetrics
                    ? `<circle cx="${iconCenterX}" cy="${iconCenterY}" r="${Math.round(5 * layoutScale)}" fill="${merged.iconColor}" opacity="0.95"/>
    <rect x="${gx + 0}" y="${gy + Math.round(3 * layoutScale)}" width="${Math.round(14 * layoutScale)}" height="${Math.round(10 * layoutScale)}" rx="${Math.round(5 * layoutScale)}" fill="${merged.iconColor}" opacity="0.95"/>`
                    : `<circle cx="${gx + Math.round(10 * layoutScale)}" cy="${metricsY - Math.round(8 * layoutScale)}" r="${Math.round(5 * layoutScale)}" fill="${merged.iconColor}" opacity="0.95"/>
    <rect x="${gx + 0}" y="${metricsY + Math.round(2 * layoutScale)}" width="${Math.round(14 * layoutScale)}" height="${Math.round(10 * layoutScale)}" rx="${Math.round(5 * layoutScale)}" fill="${merged.iconColor}" opacity="0.95"/>`;
        hash |= 0;
                iconNode = useVerticalMetrics
                    ? `<circle cx="${gx + Math.round(7 * layoutScale)}" cy="${iconCenterY}" r="${Math.round(4 * layoutScale)}" fill="${merged.iconColor}" opacity="0.95"/>
    <circle cx="${gx + Math.round(19 * layoutScale)}" cy="${iconCenterY - Math.round(2 * layoutScale)}" r="${Math.round(3 * layoutScale)}" fill="${merged.iconColor}" opacity="0.95"/>
    <rect x="${gx + 0}" y="${gy + Math.round(3 * layoutScale)}" width="${Math.round(10 * layoutScale)}" height="${Math.round(9 * layoutScale)}" rx="${Math.round(4.5 * layoutScale)}" fill="${merged.iconColor}" opacity="0.95"/>
    <rect x="${gx + Math.round(12 * layoutScale)}" y="${gy + Math.round(3 * layoutScale)}" width="${Math.round(12 * layoutScale)}" height="${Math.round(8 * layoutScale)}" rx="${Math.round(4 * layoutScale)}" fill="${merged.iconColor}" opacity="0.85"/>`
                    : `<circle cx="${gx + Math.round(7 * layoutScale)}" cy="${metricsY - Math.round(8 * layoutScale)}" r="${Math.round(4 * layoutScale)}" fill="${merged.iconColor}" opacity="0.95"/>
    <circle cx="${gx + Math.round(19 * layoutScale)}" cy="${metricsY - Math.round(10 * layoutScale)}" r="${Math.round(3 * layoutScale)}" fill="${merged.iconColor}" opacity="0.95"/>
    <rect x="${gx + 0}" y="${metricsY + Math.round(2 * layoutScale)}" width="${Math.round(10 * layoutScale)}" height="${Math.round(9 * layoutScale)}" rx="${Math.round(4.5 * layoutScale)}" fill="${merged.iconColor}" opacity="0.95"/>
    <rect x="${gx + Math.round(12 * layoutScale)}" y="${metricsY + Math.round(2 * layoutScale)}" width="${Math.round(12 * layoutScale)}" height="${Math.round(8 * layoutScale)}" rx="${Math.round(4 * layoutScale)}" fill="${merged.iconColor}" opacity="0.85"/>`;
function buildMetrics(data, merged, visibility) {
                iconNode = useVerticalMetrics
                    ? `<rect x="${gx + 0}" y="${gy - Math.round(16 * layoutScale)}" width="${Math.round(16 * layoutScale)}" height="${Math.round(18 * layoutScale)}" rx="${Math.round(4 * layoutScale)}" fill="${merged.iconColor}" opacity="0.95"/>
    <line x1="${gx + Math.round(5 * layoutScale)}" y1="${gy - Math.round(10 * layoutScale)}" x2="${gx + Math.round(17 * layoutScale)}" y2="${gy - Math.round(10 * layoutScale)}" stroke="${merged.bgColor}" stroke-width="2"/>
    <line x1="${gx + Math.round(5 * layoutScale)}" y1="${gy - Math.round(5 * layoutScale)}" x2="${gx + Math.round(15 * layoutScale)}" y2="${gy - Math.round(5 * layoutScale)}" stroke="${merged.bgColor}" stroke-width="2"/>`
                    : `<rect x="${gx + 0}" y="${metricsY - Math.round(16 * layoutScale)}" width="${Math.round(16 * layoutScale)}" height="${Math.round(18 * layoutScale)}" rx="${Math.round(4 * layoutScale)}" fill="${merged.iconColor}" opacity="0.95"/>
    <line x1="${gx + Math.round(5 * layoutScale)}" y1="${metricsY - Math.round(10 * layoutScale)}" x2="${gx + Math.round(17 * layoutScale)}" y2="${metricsY - Math.round(10 * layoutScale)}" stroke="${merged.bgColor}" stroke-width="2"/>
    <line x1="${gx + Math.round(5 * layoutScale)}" y1="${metricsY - Math.round(5 * layoutScale)}" x2="${gx + Math.round(15 * layoutScale)}" y2="${metricsY - Math.round(5 * layoutScale)}" stroke="${merged.bgColor}" stroke-width="2"/>`;
        metrics.push(`<tspan fill="${merged.iconColor}">Followers:</tspan> ${data.followers}`);
    }
            if (useVerticalMetrics) {
                return `<g>
    ${iconNode}
    <text x="${textX}" y="${gy}" fill="${merged.textColor}" font-size="${metricFont}" font-weight="600">${escapeXml(m.label)}: <tspan class="numbers" fill="${merged.titleColor}" font-size="${metricValueFont}" font-weight="700">${escapeXml(m.value)}</tspan></text>
    </g>`;
            }
    ...
    <text x="${textX}" y="${metricsY + 6}" fill="${merged.textColor}" font-size="27" opacity="0">.</text>
    <text x="${textX}" y="${metricsY + 6}" fill="${merged.textColor}" font-size="27" opacity="0">.</text>
    <text x="${textX}" y="${metricsY + Math.round(6 * layoutScale)}" fill="${merged.textColor}" font-size="${metricFont}" font-weight="600">${escapeXml(m.label)}: <tspan class="numbers" fill="${merged.titleColor}" font-size="${metricValueFont}" font-weight="700">${escapeXml(m.value)}</tspan></text>
...
const height = hasExplicitHeight ? card.cardHeight : 430;
    ...
    const avatarY = Math.round(54 * layoutScale);
        ...
        const titleFont = Math.round(30 * layoutScale);
        const metricFont = Math.round(28 * layoutScale);
        const metricValueFont = Math.round(30 * layoutScale);

    const titleY = Math.round(98 * layoutScale);
    const userY = Math.round(172 * layoutScale);
    const divider1Y = Math.round(230 * layoutScale);
    const metricsY = Math.round(280 * layoutScale);
    ...
    const metricNodes = metrics.map((m, i) => {
        ...
        const textX = gx + Math.round(34 * layoutScale);

        let iconNode = '';
        if (m.key === 'followers') {
                iconNode = `<circle cx="${gx + Math.round(10 * layoutScale)}" cy="${metricsY - Math.round(8 * layoutScale)}" r="${Math.round(5 * layoutScale)}" fill="${merged.iconColor}" opacity="0.95"/>
        <rect x="${gx + 0}" y="${metricsY + Math.round(2 * layoutScale)}" width="${Math.round(14 * layoutScale)}" height="${Math.round(10 * layoutScale)}" rx="${Math.round(5 * layoutScale)}" fill="${merged.iconColor}" opacity="0.95"/>`;
        } else if (m.key === 'following') {
                iconNode = `<circle cx="${gx + Math.round(7 * layoutScale)}" cy="${metricsY - Math.round(8 * layoutScale)}" r="${Math.round(4 * layoutScale)}" fill="${merged.iconColor}" opacity="0.95"/>
        <circle cx="${gx + Math.round(19 * layoutScale)}" cy="${metricsY - Math.round(10 * layoutScale)}" r="${Math.round(3 * layoutScale)}" fill="${merged.iconColor}" opacity="0.95"/>
        <rect x="${gx + 0}" y="${metricsY + Math.round(2 * layoutScale)}" width="${Math.round(10 * layoutScale)}" height="${Math.round(9 * layoutScale)}" rx="${Math.round(4.5 * layoutScale)}" fill="${merged.iconColor}" opacity="0.95"/>
        <rect x="${gx + Math.round(12 * layoutScale)}" y="${metricsY + Math.round(2 * layoutScale)}" width="${Math.round(12 * layoutScale)}" height="${Math.round(8 * layoutScale)}" rx="${Math.round(4 * layoutScale)}" fill="${merged.iconColor}" opacity="0.85"/>`;
        } else {
                iconNode = `<rect x="${gx + 0}" y="${metricsY - Math.round(16 * layoutScale)}" width="${Math.round(16 * layoutScale)}" height="${Math.round(18 * layoutScale)}" rx="${Math.round(4 * layoutScale)}" fill="${merged.iconColor}" opacity="0.95"/>
        <line x1="${gx + Math.round(5 * layoutScale)}" y1="${metricsY - Math.round(10 * layoutScale)}" x2="${gx + Math.round(17 * layoutScale)}" y2="${metricsY - Math.round(10 * layoutScale)}" stroke="${merged.bgColor}" stroke-width="2"/>
        <line x1="${gx + Math.round(5 * layoutScale)}" y1="${metricsY - Math.round(5 * layoutScale)}" x2="${gx + Math.round(15 * layoutScale)}" y2="${metricsY - Math.round(5 * layoutScale)}" stroke="${merged.bgColor}" stroke-width="2"/>`;
        }
...
<svg width="${width}" height="${height}" viewBox="0 0 ${width} ${height}" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="GitHub stats for ${escapeXml(data.login)}">
  <defs>
    ...
    <style><![CDATA[
        ...
        /* default: use Montserrat for general text, Space Grotesk for username, DM Mono for monospace where needed */
        svg { font-family: 'Montserrat', 'Poppins', sans-serif; }
        .username { font-family: 'Space Grotesk', 'Montserrat', sans-serif; font-weight:700; }
        .label { font-family: 'Montserrat', 'Poppins', sans-serif; }
  ...
  <line x1="${pad}" y1="${divider2Y}" x2="${width - pad}" y2="${divider2Y}" stroke="rgba(197,214,239,0.42)" stroke-width="2"/>
    ...
    <text x="${pad}" y="${labelY}" fill="${merged.iconColor}" font-size="${Math.max(14, Math.round(27 * layoutScale))}" opacity="0">.</text>
    <text x="${pad}" y="${labelY}" fill="${merged.titleColor}" font-size="${Math.max(16, Math.round(42 * layoutScale))}" opacity="0">.</text>
    <text x="${pad}" y="${labelY}" fill="${merged.titleColor}" font-size="${Math.max(16, Math.round(41 * layoutScale))}" opacity="0">.</text>
        <text x="${pad}" y="${labelY}" fill="${merged.titleColor}" font-size="${Math.max(16, Math.round(18 * layoutScale))}">Repos: <tspan class="numbers" fill="${merged.titleColor}" font-weight="700">${escapeXml(data.publicRepos)}</tspan></text>
